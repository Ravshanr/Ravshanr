...
<body>
    <div class="main-content">
        ...
        <form action="{{ route('answers.update', ['application' => $application->id]) }}" method="POST">
            @csrf
            <div class="form-group">
                <label for="body">Javobni tahrirlash:</label>
                <textarea id="body" name="body" required>{{ $answer->body ?? '' }}</textarea>
            </div>            
            <div>
